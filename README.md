...
유기문어는 웹소설 『유기무녀』의 설정을 기반으로 프로그래밍 언어입니다.

해당 언어는 [여기](https://shachixu.github.io/yugimunu/)에서 테스트 가능합니다.

또한 해당 언어의 원작 웹소설은 [여기](https://novelpia.com/novel/21232)에서 읽을 수 있습니다.
